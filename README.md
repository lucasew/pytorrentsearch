...
- 🎯 Entry points to execute your program using `python -m <pytorrentsearch>` or `$ pytorrentsearch` with basic CLI argument parsing.
...
```bash
pip install pytorrentsearch
```

## Usage

```py
from pytorrentsearch import BaseClass
from pytorrentsearch import base_function
